let _snowCanvas = function( obj ){
    ...
    **/
    ...
    canvas.style.backgroundColor = obj.background || "rgba(0,0,0,0)"; //set background color
    var fillStyle = obj.snowColor || "rgb(255,255,255)";//color of snow
